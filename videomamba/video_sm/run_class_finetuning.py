...
def main(args, ds_init):
    ...
    if args.finetune:
        ...
        if 'deit' in args.model or 'videomamba' in args.model or 'vamamba' in args.model:
    ...
    if args.eval:
        ...
        if global_rank == 0:
            ...
            if args.output_dir and utils.is_main_process():
                with open(os.path.join(args.output_dir, "log.log"), mode="a", encoding="utf-8") as f:
