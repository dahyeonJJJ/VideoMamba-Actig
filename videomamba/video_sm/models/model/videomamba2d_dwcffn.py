...
from mamba_ssm.modules.mamba_simple import Mamba, Mamba2d
...
@register_model
def videomamba2d_dwcffn_tiny(pretrained=False, **kwargs):
    model = VisionMamba(
        patch_size=16, 
        embed_dim=192, 
        depth=24, 
...
@register_model
def videomamba2d_dwcffn_small(pretrained=False, **kwargs):
    model = VisionMamba(
        patch_size=16, 
        embed_dim=384, 
        depth=24, 
...
@register_model
def videomamba2d_dwcffn_middle(pretrained=False, **kwargs):
    model = VisionMamba(
        patch_size=16, 
        embed_dim=576, 
        depth=32, 
