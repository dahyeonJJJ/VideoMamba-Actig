...
torchrun --nproc_per_node=4 \
        ...
        --dist_eval \
        --bf16 \
        --finetune './exp/ssv2/videomamba_tiny/checkpoint/videomamba_t16_ssv2_f8_res224.pth' \
        --resume './exp/ssv2/videomamba_tiny/checkpoint/videomamba_t16_ssv2_f8_res224.pth' \
        --eval
